<div class="bg-white rounded-2xl border border-slate-200 p-3 sm:p-4 shadow-sm space-y-3">
    <div class="flex items-center gap-3 flex-wrap">
        <div class="flex-1 min-w-[13rem] relative">
            ...
            <input type="search" class="w-full pl-9 pr-3 py-2.5 border border-slate-200 rounded-xl text-sm bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all" placeholder="Cari nama, kontak, atau paket wisata..." x-model="search" />
        </div>
